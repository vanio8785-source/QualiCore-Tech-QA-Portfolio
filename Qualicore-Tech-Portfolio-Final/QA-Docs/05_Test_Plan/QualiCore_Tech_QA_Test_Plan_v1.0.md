...
| Build Variants | **QA Defect Build** (primary test target) / **Stable Build** (baseline reference) |
...
**Build usage:**
- Execute defect-focused test cases against the **QA Defect Build**
- Use the **Stable Build** as the expected behavior baseline for expected vs. actual comparisons
- Retest and regression checks should be performed against the **Stable Build**
